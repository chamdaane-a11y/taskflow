...
const SECTIONS_CGU = [
  {
    id: 'objet',
    titre: '1. Objet',
    contenu: `Les présentes Conditions Générales d'Utilisation (CGU) régissent l'accès et l'utilisation de la plateforme GetShift, accessible à l'adresse https://chamdaane-a11y.github.io/getshift, éditée par Hamdaane CHITOU, domicilié au Bénin.
...
Vous êtes seul responsable du contenu que vous créez et partagez sur la plateforme.`
  },
  {
    ...
    contenu: `GetShift intègre des fonctionnalités d'intelligence artificielle (IA) fournies par des services tiers (Groq). En utilisant ces fonctionnalités, vous acceptez que :
...
— GetShift ne garantit pas l'exactitude ou la pertinence des réponses générées par l'IA.`
  },
  {
    id: 'disponibilite',
...
const SECTIONS_CONFIDENTIALITE = [
  {
    ...
    contenu: `GetShift collecte les données suivantes lors de votre inscription et utilisation du service :
...
— Tokens de vérification email et de réinitialisation de mot de passe à durée limitée.`
  },
  {
    ...
    contenu: `GetShift ne vend, ne loue et ne partage pas vos données personnelles avec des tiers, à l'exception des cas suivants :
...
Pour exercer ces droits, contactez-nous à : chamdaane@gmail.com`
  },
  {
    id: 'cookies',
    titre: '6. Cookies',
    contenu: `GetShift utilise des cookies strictement nécessaires au fonctionnement du service :
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: 'clamp(40px, 6vh, 72px) clamp(20px, 5vw, 60px) 0' }}>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <p style={{ fontSize: 15, color: '#64748b', marginBottom: 32 }}>
              Dernière mise à jour : Mars 2026 · GetShift par <strong style={{ color: '#0f172a' }}>Hamdaane CHITOU</strong>
            </p>
            ...
            <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}
              ...
              <div>
                <h3 style={{ fontSize: 15, fontWeight: 700, color: '#0f172a', marginBottom: 6 }}>
                  {onglet === 'cgu' ? "Conditions Générales d'Utilisation de GetShift" : 'Politique de Confidentialité de GetShift'}
                </h3>
                <p style={{ fontSize: 13.5, color: '#64748b', lineHeight: 1.7 }}>
                  {onglet === 'cgu'
                    ? "Ces conditions régissent votre utilisation de GetShift. En créant un compte, vous acceptez ces conditions. Prenez le temps de les lire attentivement."
                    : "Chez GetShift, la protection de vos données personnelles est une priorité. Ce document explique comment nous collectons, utilisons et protégeons vos informations."
                  }
                </p>
              </div>
            </motion.div>
