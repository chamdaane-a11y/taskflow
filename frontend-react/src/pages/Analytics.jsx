...
export default function Analytics() {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: 'var(--bg-base)', color: 'var(--text-primary)', fontFamily: "var(--font-ui)" }}>
      ...
      {/* MAIN */}
      <motion.main
        animate={{ marginLeft: isMobile ? 0 : `max(${mainMargin}px, calc(${mainMargin / 2}px + 50vw - 720px))` }}
        transition={{ type: 'spring', damping: 28, stiffness: 260 }}
        style={{ flex: 1, padding: 'clamp(20px,4vw,36px)', paddingTop: isMobile ? 'calc(56px + env(safe-area-inset-top))' : 'clamp(20px,4vw,36px)', paddingBottom: isMobile ? 90 : 'clamp(20px,4vw,36px)', overflowX: 'hidden', maxWidth: 1440, marginRight: isMobile ? undefined : 'auto' }}>
              ...
              <div style={{ padding: '20px 24px 0', borderBottom: '1px solid var(--border-subtle)', flexShrink: 0 }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    ...
                    <div>
                      <h2 style={{ fontSize: 16, fontWeight: 700, color: 'var(--text-primary)', margin: 0 }}>{t('analytics.settings_title')}</h2>
