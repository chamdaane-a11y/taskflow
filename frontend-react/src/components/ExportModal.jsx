...
<title>Rapport TaskFlow — ${nomUtilisateur}</title>
<style>
...
<div class="page">
  ...
  <div class="ia-section">
    <div class="ia-header">
      ...
      <div class="ia-header-text">
        ...
        <p>Généré par l'assistant TaskFlow</p>
      </div>
    </div>
  ...
  <!-- FOOTER -->
  <div class="footer">
    <p>Généré par <span class="footer-logo">TaskFlow</span> · ${date}</p>
    <p style="color:${C.accent}">taskflow.app</p>
  </div>
...
Inclus : bilan global, points forts, axes d'amélioration, conseils concrets. Style professionnel et bienveillant. 15-20 lignes.`
  ...
  const telechargerPDF = () => {
    ...
    const a = document.createElement('a')
    a.href = url
    a.download = `TaskFlow_Rapport_${user.nom.replace(' ', '_')}_${new Date().toLocaleDateString('fr-FR').replace(/\//g, '-')}.html`
    a.click()
    URL.revokeObjectURL(url)
  }
            ...
            <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}>
              ...
              <div style={{ marginBottom: 20 }}>
                ...
                <motion.button
                  ...
                  onClick={() => telechargerCSV(taches, `TaskFlow_${user.nom}`)}
